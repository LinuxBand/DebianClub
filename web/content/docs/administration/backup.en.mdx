...
<Callout type="info" title="Why 3-2-1?">
...
<Callout type="warn" title="⚠️ Warning">
...
<Callout type="warn" title="⚠️ Trailing Slashes Matter">
...
<Callout type="info" title="💡 Verifying Cron Tasks">
...
<Callout type="error" title="Extremely Important: Always double-check before running dd">
...
<Callout type="warn" title="⚠️ Critical Reminder">
...
<Callout type="info" title="💡 Recommended Setup for Beginners">
