...
export const architectures: Architecture[] = [
  ...
  { id: 'i386', label: 'i386 (x86)', description: { zh: '32 位（Debian 13 不再提供安装版）', en: '32-bit (no installer in Debian 13)' } },
...
export const debianVersions: DebianVersion[] = [
  {
    ...
    badge: 'success',
    architectures: architectures.filter(a => ['amd64', 'arm64', 'armhf', 'ppc64el', 'riscv64', 's390x'].includes(a.id)),
    isoTypes: isoTypes,
  },
  {
    id: 'bookworm',
