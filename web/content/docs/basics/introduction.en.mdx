...
<Callout type="warn" title="Learning Curve">

If you're new to Linux, it may take some time to adapt.

</Callout>

<Callout type="warn" title="Software Versions">
