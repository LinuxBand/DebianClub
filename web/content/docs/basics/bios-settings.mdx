...
<Callout type="info" title="✅ UEFI 优势">
...
<Callout type="warn" title="⚠️ Legacy 限制">
...
<Callout type="info" title="🔐 Secure Boot 处理">
...
<Callout type="info" title="❌ 启动故障排除">
