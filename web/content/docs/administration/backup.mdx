...
<Callout type="info" title="为什么需要 3-2-1？">
...
<Callout type="info" title="Timeshift 使用建议">
...
<Callout type="warn" title="尾部斜杠很重要">
...
<Callout type="info" title="验证 Cron 任务">
...
<Callout type="error" title="极其重要：dd 操作前务必反复确认">
...
<Callout type="info" title="新手推荐方案">
