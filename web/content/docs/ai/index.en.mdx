...
|------|-------------|--------|
| [DebianClub AI Skills](/en/ai/skills) | Debian/Linux environment detection, APT safety, command safety, systemd, networking, development setup, GPU, containers, security audits, and Debian packaging workflows | MVP |
